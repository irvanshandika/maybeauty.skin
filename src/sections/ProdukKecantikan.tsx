...
import { Perawatan } from "../data/Produk";
...
const ProductList: React.FC = () => {
  return (
    <section>
      <section>
        <div className="block max-w-7xl py-28 mx-auto justify-center lg:text-xl">
          <div className="flex justify-center mb-5">
            <h2 className="lg:text-3xl text-2xl font-semibold dark:text-gray-100">List Produk Perawatan</h2>
          </div>
