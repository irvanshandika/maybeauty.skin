          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div className="order-2 lg:order-1 lg:mt-0 mt-[200px]">
              <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight lg:translate-x-[3vw]">
                Toko <span className="text-[#F675A8]">skincare terbaik</span> di Yogyakarta
              </h1>
              <p className="mt-3 text-lg lg:translate-x-[3vw] text-gray-800 dark:text-neutral-400">Merasa tidak percaya diri dengan penampilan kamu? Jangan khawatir, kami punya solusinya.</p>
